...
#if GEOCLUE_ANDROID_GPS_INTERFACE == 3 || GEOCLUE_ANDROID_GPS_INTERFACE == 2
                                ...
                                const QByteArray &password)
{
    ...
    if (!m_agpsEnabled) {
#if GEOCLUE_ANDROID_GPS_INTERFACE == 3 || GEOCLUE_ANDROID_GPS_INTERFACE == 2 || GEOCLUE_ANDROID_GPS_INTERFACE == 1
